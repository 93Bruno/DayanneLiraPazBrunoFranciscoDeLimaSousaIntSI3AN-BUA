package br.usjt.dayannelirapazbrunofranciscodelimasousaintsi3anbua;
...
public class MainActivity extends AppCompatActivity {
    public final static String EXTRA_MESSAGE = "br.usjt.dayannelirapazbrunofranciscodelimasousaintsi3anbua.MESSAGE";
    public final static String EXTRA_INTERESSE_1 = "br.usjt.dayannelirapazbrunofranciscodelimasousaintsi3anbua.MESSAGE";
    public final static String EXTRA_INTERESSE_2 = "br.usjt.dayannelirapazbrunofranciscodelimasousaintsi3anbua.MESSAGE";
    ...
    public void sendMessage(View view) {
        ...
        if (vInteresse.equals("Técnico")) {
            ...
            extras.putString("EXTRA_INTERESSE_1", "A Ilha do Medo");
            extras.putString("EXTRA_INTERESSE_2", "A Culpa é das Estrelas");
            intent.putExtras(extras);
        }
